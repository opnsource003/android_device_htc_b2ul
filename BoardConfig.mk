...
-include vendor/htc/b2ul/BoardConfigVendor.mk
...
TARGET_BOOTLOADER_BOARD_NAME := b2ul

BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.hardware=qcom user_debug=31 ehci-hcd.park=3
BOARD_KERNEL_BASE := 0x00000000
BOARD_KERNEL_PAGESIZE := 2048
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x02008000 --dt device/htc/b2ul/dtb --tags_offset 0x01e00000

TARGET_PREBUILT_KERNEL := device/htc/b2ul/kernel
